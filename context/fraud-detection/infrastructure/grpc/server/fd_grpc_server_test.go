...
import (
	...
	"github.com/juantevez/go-posnet/context/fraud-detection/infrastructure/grpc/server"
)

func TestNewFraudDetectionServer(t *testing.T) {
	srv := server.NewFraudDetectionServer()
	if srv == nil {
		t.Fatal("NewFraudDetectionServer() = nil, want non-nil")
	}
}
