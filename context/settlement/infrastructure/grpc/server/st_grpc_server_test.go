...
import (
	...
	"github.com/juantevez/go-posnet/context/settlement/infrastructure/grpc/server"
)

func TestNewSettlementServer(t *testing.T) {
	srv := server.NewSettlementServer()
	if srv == nil {
		t.Fatal("NewSettlementServer() = nil, want non-nil")
	}
}
